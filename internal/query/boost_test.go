...
func TestContextBoost_ConfigBuilderSignals(t *testing.T) {
	queryText := "how does spring security wire HttpSecurity and WebSecurity builders into the final filter chain"
...
func TestContextBoost_SecuritySignals(t *testing.T) {
	queryText := "how does spring security authenticate a request and persist the authenticated security context"
	sm := service.SymbolMatch{
...
func TestExpandIntentQuery_DispatchAddsMvcTerms(t *testing.T) {
	queryText := "how does DispatcherServlet map an HTTP request to a controller method and write the response body"
	got := expandIntentQuery(queryText)
	if got == queryText {
...
func TestExpandIntentQuery_LifecycleAddsEventTerms(t *testing.T) {
	queryText := "how does AbstractApplicationContext refresh the container and publish lifecycle events"
	got := expandIntentQuery(queryText)
	if got == queryText {
